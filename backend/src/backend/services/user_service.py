...
from backend.models import User, UserCreate, UserUpdate, UserRead, Role
...
class UserService:
    ...
    def _populate_user_role_name(self, user: User) -> UserRead:
        """Convert User to UserRead and populate role_name."""
